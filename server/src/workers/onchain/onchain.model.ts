...
export interface OnchainRelay {
  ...
  isBatchSettledAsync?(batchId: string, marketId: string, settlementDigest?: Hex): Promise<boolean>;
  ...
  intentSubmissionSequenceAsync?(intentCommitment: Hex): Promise<bigint>;
