  ...
  apps: [
    {
      ...
      env: {
        ...
        FUNDING_IMPACT_MARGIN: "5000000000",
        FUNDING_MINIMUM_SAMPLES: "10",
        FUNDING_PREMIUM_MODE: "impact-twap",
        FUNDING_PREMIUM_RATE_CAP: "5000",
        FUNDING_SAMPLE_INTERVAL_MS: "60000",
        LIQUIDATION_AUTOMATION_ENABLED: "true",
        NODE_ENV: "production",
        PORT: "4000",
        PROTOCOL_ADMIN_REQUIRED: "true",
      },
      interpreter: "none",
      name: "pnlx-api",
      script: "bun",
    ...
    {
      args: "tunnel --url http://127.0.0.1:4000",
      cwd,
      interpreter: "none",
      name: "pnlx-api-tunnel",
      script: "cloudflared",
    },
    {
      args: "tunnel --url http://127.0.0.1:4101",
      cwd,
      interpreter: "none",
      name: "pnlx-prover-tunnel",
      script: "cloudflared",
    },
  ],
};
